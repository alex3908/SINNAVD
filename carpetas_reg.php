...
<table  >
	...
	$query="SELECT carpeta_inv.id, carpeta_inv.nuc, carpeta_inv.fecha_ini, casos.folio_c, carpeta_inv.estado, carpeta_inv.tipo_pross, carpeta_inv.asignado from casos, carpeta_inv where casos.id=carpeta_inv.id_caso and respo_reg='$id_usuario' and asignado='0' ";
