        ...
        <div id="main">
            <div class="inner">
                ...
                <div class="box">
                    ...
                    <form id="familia" enctype="multipart/form-data" name="familia"
                        ...
                        <table>
                            ...
                            ?><tr>
                                    ...
                                    <td><input class="button special fit" name="agregar" id="agregar" type="button"
                                            value="Añadir al caso"
                                            onclick="location='registro_nna_curp.php?idPc=<?= $idPc?>&idNnaR=<?= $idNnaR; ?>'">
                                    </td>
                                    <?php } ?>
                                </tr>
                                <?php } ?>
                    ...
                    <input type="button" value="Crear Caso " class="button special"
                        onclick="location='registro_caso_relacion.php?idPc=<?= $idPc?>'">
                    <?php } ?>
                </div>
                <input type="button" value="Cancelar " class="button special"
