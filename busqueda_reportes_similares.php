<?php
  ...
  if(!empty($_POST['CrearPosibleCaso']))
  {
    ...
    '$idAsentamiento', '$nombreAsentamiento', '$idCalle', '$numExt', '$numInt','$idPosCaso')";
    ...
    if($rRegPosibleCaso){
      if (!empty($name)){    
          ...
          } else echo "Error: ".$qRelacionNames;
          } else echo "Error: ".$qInsertarName;
        } else
        header("Location: reg_nna_reportados.php?idPosibleCaso=$idPosCaso");
      } else echo "Error: ".$qRegPosibleCaso;
    } else echo "Error: ".$qrelacionarPosibleCaso;
  }
    ...
    <div id="wrapper">
      ...
      <div class="inner">
          ...
          <div class="box">
            <div class="row uniform">
              ...
              <div class="3u 12u$(xsmall)">
                <input type="text" id="txtFechaReg" name="txtFechaReg" value="<?php echo $fechaReg;?>" disabled>
              </div>    
            </div>
          </div>
          <div class="box">
            <div class="row uniform">
              <div class="3u">
                ...
                <input type="text" id="txtRecepcion" name="txtRecepcion" value="<?php echo $aRecpcion; ?>" disabled >
              </div>
              <div class="2u">
                <label for="txtDistrito">Distrito</label>
                <input type="text" id="txtDistrito" name="txtDistrito" value="<?php echo $aDistrito; ?>" disabled >
              </div>
              <div class="7u">
            ...
            <div class="row uniform">
              <div class="2u 12u$(xsmall)">
                ...
                <input type="text" id="txtEntidad" name="txtEntidad" value=" <?php echo $estado; ?>" disabled > 
              </div>
              <div class="4u 12u$(xsmall)">
                <label for="txtMunicipio">Municipio:</label>
                <input type="text" id="txtMunicipio" name="txtMunicipio" value="<?php echo $municipio; ?>" disabled >  
              </div>
              <div class="4u 12u$(xsmall)">
                <label for="txtLocalidad">Localidad:</label>
                <input type="text" id="txtLocalidad" name="txtLocalidad" value="<?php echo $localidad;  ?>" disabled>  
              </div>
              <div class="2u 12u$(xsmall)">
            ...
            <div class="row uniform">
              <div class="3u 12u$(xsmall)">
                ...
                <input type="text" id="txtTipoAsentamiento" name="txtTipoAsentamiento" value=" <?php echo $tipoAsentamiento; ?>" disabled> 
              </div>
              <div class="3u 12u$(xsmall)">
                <label for="txtAsentamiento">Nombre del asentamiento:</label>
                <input type="text" id="txtAsentamiento" name="txtAsentamiento" value=" <?php echo $nombreAsentamiento; ?>" disabled> 
              </div>
              <div class="3u 12u$(xsmall)">
                <label for="txtTipoVialidad">Tipo de vialidad:</label>
                <input type="text" id="txtTipoVialidad" name="txtTipoVialidad" value="<?php echo $tipoCalle;?>" disabled>  
              </div>
              <div class="3u 12u$(xsmall)">
                <label for="txtVialidad">Nombre de la vialidad:</label>
                <input type="text" id="txtVialidad" name="txtVialidad" value="<?php echo $calle; ?>" disabled>  
              </div>
            </div>
            <div class="row uniform">
	                ...
	                <div class="12u 12u$(xsmall)">
							      ...
							      <input type="text" id="txtNumEx" name="txtNumEx" maxlength="100" style="text-transform:uppercase;" value="<?php echo $numExt; ?>" onkeyup="this.value=this.value.toUpperCase();" disabled>
								  </div>
                </div>
                <div class="row uniform">
									<div class="12u 12u$(xsmall)">
									  <label for="txtNumInt">Número int.</label>
									  <input type="text" id="txtNumInt" name="txtNumInt" maxlength="100" style="text-transform:uppercase;" value="<?php echo $numInt; ?>" onkeyup="this.value=this.value.toUpperCase();" disabled>
									</div>
								</div> <!--uniform-->
							</div> <!--3u-->
              <div class="9u 12$(xsmall)">
                  ...
                  <div class="12u 12u$(xsmall)">
                    <label for="ubicacion">Referencias sobre el domicilio</label>
								    <textarea name="ubicacion" rows="5" maxlength="300" cols="100" style="text-transform:uppercase;" onkeyup="this.value=this.value.toUpperCase();" disabled><?php echo $ubicacion; ?>
                    </textarea>
                  </div>
                </div>
              </div>
            ...
            <div class="row uniform"> 
              <div class="6u 12u$(xsmall)">
                ...
                <textarea name="txtNarracion" id="txtNarracion" rows="6" cols="20" maxlength="1000" style="text-transform:uppercase;" onkeyup="this.value=this.value.toUpperCase();" disabled><?php echo $narracion; ?></textarea>
              </div>
              <div class="6u 12u$(xsmall)">
                <label for="txtDatosRelevates">Otros datos u observaciones relevantes:</label>
                <textarea name="txtDatosRelevates" id="txtDatosRelevates" rows="6" cols="20" maxlength="1000" style="text-transform:uppercase;" onkeyup="this.value=this.value.toUpperCase();" disabled><?php echo $otros;  ?></textarea>
              </div>
            </div><br>
          </div><br>
          <div class="row uniform">
            <div class="12u 12u$(xsmall)">
              <input class="button special fit" name="CrearPosibleCaso" type="submit" value="Crear posible caso">
            </div>
          </div>
        </form>        
        <div class="box alt" align="center">
          <h3>Reportes posiblemente relacionados</h3><p>
          <div class="row uniform">
          <div class="12u 12u$(xsmall)">
        ...
        <form id="buscador" name="buscador" method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>" onSubmit="return validarForm(this)">
          <div class="row uniform">            
            <div class="3u 12u$(xsmall)">
            <input type="text" id="txtNomNna" name="txtNomNna" maxlength="30" style="text-transform:uppercase;" onkeyup="this.value=this.value.toUpperCase();" placeholder="NOMBRE">
            </div>
            <div class="3u 12u$(xsmall)">
            <input type="text" id="txtApePNna" name="txtApePNna" maxlength="30" style="text-transform:uppercase;" onkeyup="this.value=this.value.toUpperCase();" placeholder="Apellido paterno">
            </div>
            <div class="3u 12u$(xsmall)">
            <input type="text" id="txtApeMNna" name="txtApeMNna" maxlength="30" style="text-transform:uppercase;" onkeyup="this.value=this.value.toUpperCase();" placeholder="Apellido Materno">
            </div>
            <div class="3u 12u$(xsmall)">
          ...
          <?php  while ($row2=$rReportesRelacionados->fetch_assoc()) { 
            ...
            <div class="box">
              <div class="box-header with-border">
                <div class="row uniform">
                  <div class="9u 12u$(xsmall)">
                    <h5>Reporte con folio <?php echo $row2['folio']; ?> perteneciente al posible caso <?php echo $row2['folioPC']; ?></h5>
                  </div>
                  <div class="3u 12u$(xsmall)">
                    <input class="button" name="relacionar" id="relacionar"  value="Añadir" onclick="location='relacionarRep-PosCaso.php?idPC=<?php echo $idPC; ?>'">
                  </div>
                </div>
              </div> 
              <div class="box-body">
                <table>
                  ...
                  <body>
                    <tr>
                      ...
                      <td><?php echo $row2['asentamiento']." ".$row2['nombre_asentamiento']; ?></td>
              ...
              </div>  <!--cierrre box-body-->
              <div class="box-footer">
                <div class="table-wrapper"><h5>Datos del NNA</h5>
                  <table>
                    <thead>
                      <tr>
                        <td>Nombre</td>
