...
require 'Classes/PHPExcel.php';
	...
	//Consulta
	$sql = "SELECT id, nombre, apellido_p, apellido_m FROM nna";
	$resultado = $mysqli->query($sql);
	$fila = 7; //Establecemos en que fila inciara a imprimir los datos
	
	$gdImage = imagecreatefrompng('images/advertencia.png');//Logotipo
	...
	while($rows = $resultado->fetch_assoc()){
		...
		$objPHPExcel->getActiveSheet()->setCellValue('C'.$fila, $rows['apellido_p']);
		$objPHPExcel->getActiveSheet()->setCellValue('D'.$fila, $rows['apellido_m']);
