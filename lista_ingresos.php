...
$ing = "SELECT nna_centros.id as id_nna_centros, nna.nombre, nna.apellido_p, nna.apellido_m, centros.nombre
    ...
    <div id="wrapper">
        ...
        <div id="main">
            <div class="inner"><br>
                ...
                <h2>Lista ingresos de NNA a Centro de Asistencía Social.</h2>
                <?php if ($rowing == '0') {
    echo "SIN REGISTROS";
} else {?>
