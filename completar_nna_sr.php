        ...
        <div id="main">
            <div class="inner">
                ...
                <div class="box">
                    ...
                    <div class="row uniform">
                        ...
                        <div class="3u">
                            ...
                            <input type="text" name="txtEdoNac" style="text-transform:uppercase;" value="<?=$edoNac?>"
                                disabled>
                        </div>
                    </div>
                    ...
                    <div class="row uniform">
                        <div class="2u">
                            ...
                            <input id="txtnacionalidad" name="txtnacionalidad" type="text"
                                style="text-transform:uppercase;" onkeyup="this.value=this.value.toUpperCase();"
                                value="<?=$nacionalidad?>" disabled>
                        </div>
                        <div class="7u">
                            <label for="txtStaCurp">Estatus CURP</label>
                            <input id="txtStaCurp" name="txtStaCurp" type="text" style="text-transform:uppercase;"
                                onkeyup="this.value=this.value.toUpperCase();" value="<?=$stCurp?>" disabled>
                        </div>
                        <div class="3u">
                            <label for="txtDoc">Documento probatorio</label>
                            <input id="txtDoc" name="txtDoc" type="text" style="text-transform:uppercase;"
                                onkeyup="this.value=this.value.toUpperCase();" value="<?=$ADocProbatorio?>" disabled>
                        </div>
                    </div>
                    ...
                    <div class="row uniform">
                        <div class="3u">
                            ...
                            <input id="txtNumAct" name="txtNumAct" type="text" style="text-transform:uppercase;"
                                onkeyup="this.value=this.value.toUpperCase();" value="<?=$numActa?>" disabled>
                        </div>
                        <div class="3u">
                            <label>Año de registro</label>
                            <input id="txtAnioReg" name="txtAnioReg" type="text" style="text-transform:uppercase;"
                                onkeyup="this.value=this.value.toUpperCase();" value="<?=$anioReg?>" disabled>
                        </div>
                        <div class="6u">
                            <label>Lugar de Registro</label>
                            <input id="txtLugReg" name="txtLugReg" type="text" style="text-transform:uppercase;"
                                onkeyup="this.value=this.value.toUpperCase();" value="<?=$lugarReg?>" disabled>
                        </div>
                    </div>
                    <?php }
}?>
                    ...
                    <div class="box">
                        <div class="row uniform">
                            ...
                            <div class="2u">Lugar de nacimiento
                                <input id="lugarNacimiento" name="lugarNacimiento" type="text"
                                    style="text-transform:uppercase;" onkeyup="this.value=this.value.toUpperCase();">
                            </div>
                            <div class="2u">Lugar de registro
                                <input id="LugarRegistro" name="LugarRegistro" type="text"
                                    style="text-transform:uppercase;" onkeyup="this.value=this.value.toUpperCase();">
                            </div>
                            <div class="2u">Estado civil y/o familiar
                                <div class="select-wrapper">
                                    <select id="edo_civil" name="edo_civil" style="text-transform:uppercase;"
                                        onkeyup="this.value=this.value.toUpperCase();">
                                        <option value="">--Seleccione--</option>
                                        <?php while ($rwc = $rEdoCivil->fetch_assoc()) {?>
                                        <option value="<?php echo $rwc['id']; ?>"><?php echo $rwc['estado_civil']; ?>
                                        </option>
                                        <?php }?>
                                    </select>
                                </div>
                        ...
                        <div class="row uniform">
                            <div class="12u">
                                <input type="text" name="txtDireccion" id="txtDireccion"
                                    tyle="text-transform:uppercase;" onkeyup="this.value=this.value.toUpperCase();"
                    ...
                    <div class="box">
                        ...
                        <div class="row uniform">
                            <div class="4u">Persona Responsable del NNA
                                <input id="txtPersona" name="txtPersona" type="text" style="text-transform:uppercase;"
                                    onkeyup="this.value=this.value.toUpperCase();" maxlength="100">
                            </div>
                            <div class="4u">Parentesco
                                <input id="txtParentesco" name="txtParentesco" type="text"
                                    style="text-transform:uppercase;" onkeyup="this.value=this.value.toUpperCase();"
                                    maxlength="50">
                            </div>
                            <div class="4u">Teléfono
                                <input id="txtTelefono" name="txtTelefono" type="text" style="text-transform:uppercase;"
                                    onkeyup="this.value=this.value.toUpperCase();" maxlength="50">
                            </div>
                        </div>
                        <div class="row uniform">
                            <div class="6u">Dirección
                                <input id="txtDirPersona" name="txtDirPersona" type="text"
                                    style="text-transform:uppercase;" onkeyup="this.value=this.value.toUpperCase();"
                                    maxlength="150">
                            </div>
                            <div class="6u">Observaciones
                                <input id="txtObservaciones" name="txtObservaciones" type="text"
                                    style="text-transform:uppercase;" onkeyup="this.value=this.value.toUpperCase();"
                                    maxlength="150">
                            </div>
                        </div>
                ...
                <div class="12u 12u$(xsmall)">
                    <input type="button" name="cancelar" value="carcelar" class="button fit"
                        onclick="location='lista_nna.php'">
                </div>
            </div>
        </div>
