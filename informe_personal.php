...
<body>
    ...
    if ($_POST["meses"] == $key) {
        ...
        echo "<option value='" . $key . "'>" . $value . "</option>";
                        ...
                        <div class="3u">
                            <input id="fecha_ini" name="fecha_ini" type="date" placeholder="dd/mm/aaaa"
                                value="<?=$fecha_ini?>">
                        </div>
                        <div class="0.5u">
                            <label>a: </label>
                        ...
                        <div class="3u">
                            <input id="fecha_fin" name="fecha_fin" type="date" placeholder="dd/mm/aaaa"
                                value="<?=$fecha_fin?>">
                        </div>
                        <div class="2u">
                            ...
                            <div class="table-wrapper">
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?=$row['folio']?></td>
                                            <td><?=$row['nombre'] . " " . $row['apellido_p'] . " " . $row['apellido_m']?>
                                            </td>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$row2['nombre'] . " " . $row2['apellido_p'] . " " . $row2['apellido_m']?>
                                            </td>
                                            <td><?=$row2['medidas']?></td>
                                        </tr>
                                        <?php }?>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$row3['nombre'] . " " . $row3['apellido_p'] . " " . $row3['apellido_m']?>
                                            </td>
                                            <td><?=$row3['medidas']?></td>
                                        </tr>
                                        <?php }?>
                    ...
                    <div class="row">
                        ...
                        <div class="6u">
                            Reportes de casos de vulneración de derechos de niñas, niños y adolescentes que resultaron
                            positivos en vulneración de derechos
                        </div>
                        <div class="2u">
                            <?=$totAct1_1?>
                        </div>
    ...
    ?>
        ...
        if ($atend == '1' or empty($atend)) {?>
                    ...
                    <div class="row">
                        ...
                        <div class="6u">
                            Intervenciones de trabajo social a niñas, niños y adolescentes en situacion de vulneracion
                            de derechos realizadas
                        </div>
                        <div class="2u">
                            <?php if (empty($totAct2_1)) {
        echo "0";
    } else {
        echo $totAct2_1;
    }
    ?>
                    ...
                    <div class="row">
                        ...
                        <div class="6u">
                            Reportes de casos de posible vulneración de derechos de niñas, niños y adolescentes
                            recibidos
                        </div>
                        <div class="2u">
                            <?=$totAct2_2?>
        ...
        if ($atend == '1' or empty($atend)) {?>
                    ...
                    <div class="row">
                        ...
                        <div class="6u">
                            Intervenciones psicológicas a niñas, niños y adolescentes en situación de vulneración de
                            derechos brindadas
                        </div>
                        <div class="2u">
                            <?=$totAct3_1?>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$row8['nombre'] . " " . $row8['apellido_p'] . " " . $row8['apellido_m']?>
                                            </td>
                                        </tr>
                                        <?php }?>
                                    </tbody>
                    ...
                    <div class="row">
                        ...
                        <div class="6u">
                            Niñas, niños y adolescentes con derechos vulnerados atendidos por primera vez en la
                            ...
                            <div class="table-wrapper">
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?=$row9['folio']?></td>
                                            <td><?=$row9['nombre'] . " " . $row9['apellido_p'] . " " . $row9['apellido_m']?>
                                            </td>
                                            <td><?=$row9['curp']?></td>
                            ...
                            <div class="table-wrapper">
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?=$row10['fecha']?></td>
                                            <td><?=$row10['nombre'] . " " . $row10['apellido_p'] . " " . $row10['apellido_m']?>
                                            </td>
                            ...
                            <div class="table-wrapper">
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?=$row13['folio_c']?></td>
                                            <td><?=$row13['nombre'] . " " . $row13['apellido_p'] . " " . $row13['apellido_m']?>
                                            </td>
                                            <td><?=$row13['medidaC']?></td>
                                            <td><?=$row13['area']?></td>
                    ...
                    <div class="row">
                        ...
                        <div class="6u">
                            Medidas de protección en el plan de restitución de derechos a niñas, niños y adolescentes
                            decretadas
                        </div>
                        <div class="2u">
                            <?=$totAct6_2?>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$row14['medidaC']?></td>
                                            <td><?=$row14['nombre'] . " " . $row14['apellido_p'] . " " . $row14['apellido_m']?>
                                            </td>
                                            <td><?=$row14['responsable_med']?>
                                            <td><?=$row14['fecha']?></td>
                                            <td> <?php $es = $row14['estado'];
        if ($es == 0) {?>
                                                <input type="image" src="images/no_ejecutada.png" height="40"
                                                    width="40">
                            ...
                            <div class="table-wrapper">
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?=$row16['nombre'] . " " . $row16['apellido_p'] . " " . $row16['apellido_m']?>
                                            </td>
                                            <td><?=$row16['centro']?></td>
                                            <td><?=$row16['motivo']?></td>
                            ...
                            <div class="table-wrapper">
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?=$row17['nombre'] . " " . $row17['apellido_p'] . " " . $row17['apellido_m']?>
                                            </td>
                                            <td><?=$row17['centro']?></td>
                                            <td><?=$row17['motivo']?></td>
                            ...
                            <div class="table-wrapper">
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?=$row18['nombre'] . " " . $row18['apellido_p'] . " " . $row18['apellido_m']?>
                                            </td>
                                            <td><?=$row18['centro']?></td>
                                            <td><?=$row18['motivo']?></td>
                            ...
                            <div class="table-wrapper">
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?=$row19['folio']?></td>
                                            <td><?=$row19['nombre'] . " " . $row19['apellido_p'] . " " . $row19['apellido_m']?>
                                            </td>
                                            <td><?=$row19['sexo']?></td>
                    ...
                    <div class="row">
                        ...
                        <div class="6u">
                            No. de acompañamiento de atención especial a niñas, niños, adolescentes migrantes
                            extranjeros brindado
                        </div>
                        <div class="2u">
                            <?=$totAct26_1?>
                        </div>
                            ...
                            <div class="table-wrapper">
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?=$row20['folio']?></td>
                                            <td><?=$row20['nombre'] . " " . $row20['apellido_p'] . " " . $row20['apellido_m']?>
                                            </td>
                                            <td><?=$row20['sexo']?></td>
                                ...
                                <table>
                                    <thead1 <tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?=$row21['folio']?>
                                                <td><?=$row21['nombre'] . " " . $row21['apellido_p'] . " " . $row21['apellido_m']?>
                                                </td>
                                                <td><?=$row21['sexo']?></td>
        ...
        ?>
                    ...
                    <div class="row">
                        ...
                        <div class="6u">
                            Apoyo en especie a niñas, niños y adolescentes en situación de vulneración de derechos
                            representados por la Procuraduría Protección de Niñas, Niños, Adolescentes y la Familia
                            otorgado
                        </div>
                        <div class="2u">
                            <?=$totAct28_1?>
                            ...
                            <div class="table-wrapper">
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?=$row24['nombre'] . " " . $row24['apellido_p'] . " " . $row24['apellido_m']?>
                                            </td>
                                            <td><?=$row24['centro']?></td>
                                            <td><?=$row24['motivo']?></td>
