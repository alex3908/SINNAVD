...
ob_start();
	...
	$etper=$mysqli->query($tper);$etper2=$mysqli->query($tper);
	...
	if(!empty($_POST))
	{
		...
		$turnar="UPDATE reportes_vd set asignado_psic='$respoP', fecha_asigp='$fecha' where id='$idReporte'";
		...
		<br>
			...
			<div class="12u$">
				<div class="select-wrapper">
					<select id="respoP" name="respoP" required>
						<option value="">Seleccione a Psicologia...</option>
						<?php while($row = $etper2->fetch_assoc()){ ?>
