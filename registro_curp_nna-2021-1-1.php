	...
	if(isset($_POST['btnRegistar'])) {  
		...
		if($registrado==0 or $registrado==4 or $registrado==9){ //sin registros en renapo ni en bd, o con datos incompletos 
			...
			$qRegistroNna="INSERT INTO nna(folio, nombre, apellido_p, apellido_m,  fecha_nacimiento, sexo, 
                id_estado_nacimiento, lugar_nac, lugar_reg, estado, respo_reg, nna_ex, fecha_registro, id_estado, municipio, localidad, direccion, indigena, afrodescendiente, migrante, id_estado_civil, responna, parentesco, direccion_respo, telefono, observaciones, origen, lugOrigen, violentado, tipoViolencia, llegoAlEstado) 
                VALUES ('$folio', '$nombre', '$apellido_p', '$apellido_m',  '$fechaNac', '$sexo', 
                '$entiNac', '$txtLugarNacimiento', '$lugarReg', 'P', '$idDEPTO', '0', '$fecha', '$id_estado', '$id_mun', '$id_loc', '$direccion', '$banIndigena', '$banAfro','$banMigra', '$est_civil', '$personaRes', '$parentesco', '$dirRespo', '$telefono', '$observa', '$origen' , '$lugOrigen', '$rViolencia', '$tipoViolencia', $llegoAlEstado)"; 
			} else {
                ...
                parentesco, direccion_respo, telefono, observaciones, origen, lugOrigen, violentado, tipoViolencia, llegoAlEstado) 
                ...
                '$entiNac', '$txtLugarNacimiento', '$lugarReg', 'P', '$idDEPTO', '0', '$fecha', '$id_estado', '$id_mun', '$id_loc', '$direccion', '$banIndigena', '$banAfro','$banMigra', '$est_civil',
                 '$personaRes', '$parentesco', '$dirRespo', '$telefono', '$observa', '$origen' , '$lugOrigen', '$rViolencia', '$tipoViolencia', $llegoAlEstado)"; 
			}
            ...
            if($rRelacion and $rRelacionCaso){		//si se relaaciono bien crea historicos 
				...
				if($rHstDirecciones){
					...
					if($ractDirec){
						if($validada==0){
							...
							if($rRegHstNna and $rRegHisRes){
								if($DocProbatorio=='1'){
									...
									observaciones='$observa', origen='$origen', lugOrigen='$lugOrigen', violentado='$rViolencia', tipoViolencia='$tipoViolencia' , llegoAlEstado= '$llegoAlEstado'
									WHERE id = '$idNnaReg'";
								} else {
									$actNna="UPDATE nna SET nombre='$nombre', apellido_p='$apellido_p',
									apellido_m = '$apellido_m', curp= '$curp',fecha_nacimiento = '$fechaNac',
									...
									responna='$personaRes', parentesco='$parentesco', 
									direccion_respo='$dirRespo', telefono='$telefono', 
									observaciones='$observa', origen='$origen', lugOrigen='$lugOrigen', violentado='$rViolencia', tipoViolencia='$tipoViolencia', llegoAlEstado='$llegoAlEstado' WHERE id = '$idNnaReg'";
								}
						...
						else header("Location: verificar_datos_nna.php?idPc=$idPc");
					} else echo $qactDirer;
					...
					if($ractDirec){
						if($validada==0){
							...
							if($rRegHstNna){
									...
									afrodescendiente = '$banAfro', migrante='$banMigra', origen='$origen', lugOrigen='$lugOrigen', violentado='$rViolencia', tipoViolencia='$tipoViolencia', llegoAlEstado= '$llegoAlEstado'
									WHERE id = '$idNnaReg'";
		   ...
		   if($DocProbatorio=='1'){ //acta de nacimiento
			   ...
			   indigena, afrodescendiente, migrante, responna, parentesco, direccion_respo, observaciones, telefono, origen, lugOrigen, violentado, tipoViolencia, llegoAlEstado ) 
			   VALUES ('$folio', '$nombre', '$apellido_p', '$apellido_m', '$curp', '$fechaNac', '$sexo', 
			   ...
			   '$banMigra', '$personaRes', '$parentesco', '$dirRespo', '$observa', '$telefono', '$origen' , '$lugOrigen', '$rViolencia', '$tipoViolencia', '$llegoAlEstado')";
		   } else {
				  ...
				  migrante, responna, parentesco, direccion_respo, observaciones, telefono, origen, lugOrigen, violentado, tipoViolencia, llegoAlEstado') 
				  VALUES ('$folio', '$nombre', '$apellido_p', '$apellido_m', '$curp', '$fechaNac', '$sexo', 
				  ...
				  '$observa', '$telefono', '$origen' , '$lugOrigen', '$rViolencia', '$tipoViolencia', '$llegoAlEstado')"; 
		   } 
