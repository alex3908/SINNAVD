...
$rcarp=$mysqli->query($qcarpe);
	...
	$sqlnna="SELECT nna.folio, nna.indigena, nna.afrodescendiente, nna.nombre, nna.apellido_p, nna.curp, nna.apellido_m, 
	...
	nna.validacionRenapo, nacionalidad, docProbatorio, statusCurp, estado_civil
							...
							<div class="6u 12u$(xsmall)">
								<div class="box">
									<ul class="alt">
										...
										<li><h4>Origen: </h4><?php if($row['indigena']==1 and $row['afrodescendiente']==1) echo "INDIGENA Y AFRODESCENDIENTE";
										else if($row['indigena']==1) echo "INDIGENA"; else if($row['afrodescendiente']==1) echo "AFRODESCENDIENTE"; ?> </li>
										<li><h4>Estado civil: </h4><?php echo $row['estado_civil'];  ?> </li>	
									</ul>
								</div>
							</div>
							<div class="6u 12u$(xsmall)">
