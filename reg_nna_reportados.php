...
<html>
	...
	<body>		
		<!-- Wrapper -->
						...
						<div class="inner">
							...
							<div class="box alt" align="center">
                                ...
                                <div class="row uniform">
                                    ...
                                    <input id="nombre" name="nombre" type="text" maxlength="50" required style="text-transform:uppercase;" onkeyup="this.value=this.value.toUpperCase();">
                                    </div>
                                    <div class="3u 12u$(xsmall)">Primer apellido:
                                    <input id="apellido_p" name="apellido_p" type="text" value=" " maxlength="50" style="text-transform:uppercase;" onkeyup="this.value=this.value.toUpperCase();">
                                    </div>
                                    <div class="3u 12u$(xsmall)">Segundo apellido:
                                    <input id="apellido_m" name="apellido_m" type="text" value=" " maxlength="50" style="text-transform:uppercase;" onkeyup="this.value=this.value.toUpperCase();">
                                    </div>
                                ...
                                <div class="row uniform">
                                    ...
                                    <input id="fecha_nacimiento" name="fecha_nacimiento" value="" type="date"  max='<?php echo $fecMax?>' >
                                    </div>
								...
								<div class="12u 12u$(xsmall)">
											<input class="button special fit" name="registrar" id="registrar" type="submit" value="Añadir NNA" <?php if($reva==0) {?> disabled <?php } ?>>	
								</div>	</div>
								<div class="box alt" align="center">
								<?php if($numNna>0){?>
									<table>			
										...
										<tr>
											...
											<?php if($reva==1){ ?>
											<td><a href="perfil_nna_reportado.php?idNna=<?php echo $row['idNna'];?>&id=<?php echo $folio;?>">Editar</a></td>
											<td><a href="borrar_nna_reportado.php?idNna=<?php echo $row['idNna'];?>&id=<?php echo $folio;?>">Eliminar</a></td>
										<?php if ($row["sexo"]=='Mujer' && $row["edad"]<15) { if($numName==0){ ?>
										<td><a href="name.php?id=<?php echo $row['idNna'];?>&idPc=<?php echo $folio;?>">Registrar como NAME</a></td>
										<?php } else {?>
											<td><a href="name.php?id=<?php echo $row['idNna'];?>&idPc=<?php echo $folio;?>">NAME</a></td>
										<?php } } } } ?>
										</tr>
										</body>
									</table>
            ...
            <div class="row uniform">		
				<div class="12u 12u$(xsmall)">
					<input class="button fit" type="button" name="Terminar" value="Siguiente" onclick="location='perfil_posible_caso.php?idPosibleCaso=<?php echo $folio?>'" <?php if($reva==0 or $numNna==0) {?> disabled <?php } ?>>
				</div>
			</div>
		</form>
