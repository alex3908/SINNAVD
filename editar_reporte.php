	...
	if(!empty($_POST['registar'])){
		...
		echo "Seleccione al menos un tipo de maltrato";
			...
			if($rHistorico){
				...
				ubicacion='ubicacion', num_ext='$numExt', num_interior='$numInt' where id=$idRep";
			...
			<div id="main">
				<div class="inner">
					...
					<div class="box">
						...
						<div class="box"><h4>Editar</h4>
							<div class="row uniform">
								<div class="6u">
									<label for="txtCalle">Vialidad</label>
									<input type="text" name="txtCalle" value="<?=$calle?>" maxlength="100" style="text-transform:uppercase;" onkeyup="this.value=this.value.toUpperCase();" >
								</div>
								<div class="3u">
									<label for="txtNE">Número exterior</label>
									<input type="text" name="txtNE" value="<?=$calle?>" maxlength="20" style="text-transform:uppercase;" onkeyup="this.value=this.value.toUpperCase();" >
								</div>
								<div class="3u">
									<label for="txtNI">Número interior</label>
									<input type="text" name="txtNI" value="<?=$calle?>" maxlength="20" style="text-transform:uppercase;" onkeyup="this.value=this.value.toUpperCase();" >
								</div>
							</div>
							<div class="row uniform">
								<div class="12u">
									<label for="txtubicacion">Ubicación</label>
									<input type="text" name="txtubicacion" value="<?=$ubicacion?>" maxlength="300" style="text-transform:uppercase;" onkeyup="this.value=this.value.toUpperCase();" >
								</div>
							</div>
							<div class="row uniform">
								<div class="12u">Tipos de maltrato identificados: 
									<div class="box">
										...
										while($rwMal=$etmaltrato->fetch_assoc()) { 
											...
											?>
											<div class="4u">
												<input type="checkbox" id="<?php echo 'demo-'.$i; ?>" name="maltrato[]" value="<?php echo $rwMal['maltrato'];?>" <?php if($che) { ?> checked="true" <?php } ?> >
												<label for="<?php echo 'demo-'.$i; ?>"><?php echo $rwMal['maltrato']; $i++;?></label>
											</div>
										<?php $i++; } ?>
										</div>
									</div>
							...
							<div class="row uniform">
								<div class="6u">
									...
									<textarea name="txtNarracion" rows="6" cols="20" maxlength="1000" style="text-transform:uppercase;" onkeyup="this.value=this.value.toUpperCase();" required ><?= $narracion ?></textarea>
								</div>
								<div class="6u">
									<label>Otros datos u observaciones relevantes</label>
									<textarea name="txtOtros" rows="6" cols="20" maxlength="1000" style="text-transform:uppercase;" onkeyup="this.value=this.value.toUpperCase();" required><?= $otros ?></textarea>
								</div>
					...
					<div class="row uniform">
						<div class="6u 12u$(xsmall)">
							...
							<?php } else  { ?>
							<input class="button special fit" name="registar1" type="submit" value="Actualizar"  disabled="true">
						<?php } ?>	
						</div>
						<div class="6u 12u$(xsmall)">
							<input class="button fit" type="button" name="cancelar" value="Cancelar" onclick="location='perfil_posible_caso.php?idPosibleCaso=<?=$idPc?>'" >
						</div>
					</div>
					</form>
