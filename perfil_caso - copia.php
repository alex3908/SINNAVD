												...
												<tr>
													...
													<td>
														...
														<?php } else { 
															...
															<input name="btnrestituidos" class="button fit small" type="button" value="nna con derechos restituidos" onclick="location='derechos_rest.php?id=<?php echo $idn; ?>&idC=<?php echo $idCaso; ?>'">
														<?php } ?>
													</td>
