		...
		{	
			?>
					...
					<input type="checkbox" id="<?php echo 'demo-'.$i; ?>" name="atenci[]" value="<?php echo $row['id'];?>" >
							<label for="<?php echo 'demo-'.$i; ?>"><?php echo $row['derecho'];?></label>	</div>
    <?php 
		$i++;	}
  	?>
					</div>		
								<input type="button" class="button special fit" value="generar cuadro guía" onclick="location='atenciones_area.php'" ><br><br>
						</div>
					</div>
