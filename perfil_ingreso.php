        ...
        <div id="main">
            ...
            <div class="inner"><br> <br>
                ...
                <div class="row uniform">
                    ...
                    <div class="1u">
                        <input type="button" class="button small" value="ATRAS"
                            onclick="location='nnaENcas.php?id=<?php echo $row['idC']; ?>'">
                    </div>
                    <div class="8u">
                    ...
                    <?php if ($rows2 > 0) {?>
                    <div class="3u">
                        <input type="button" class="button special small fit"
                            onclick="location='egreso_cas.php?id=<?php echo $idNNA; ?>'" value="egresar">
                    </div>
                    <?php }?>
