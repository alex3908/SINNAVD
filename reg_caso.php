...
$erepo=$mysqli->query($reportesvd);
	...
	if(!empty($_POST))
	{
		...
		if($rows > 0) {
			...
			$sqlNino = "INSERT INTO casos(folio_c,nombre, descripcion, funcionario_reg, fecha_registro) VALUES ('$folio','$nombre', '$descripcion', '$idDEPTO', '$fecha_h')";
