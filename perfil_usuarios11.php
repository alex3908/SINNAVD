...
$erepo=$mysqli->query($reportesvd);
	...
	usuarios.indigena, cat.estado_civil, usuarios.correo
	FROM usuarios
		...
		<div id="wrapper">
			...
			<div id="main">	
					...
					<ul class="alt">
						...
						<li><strong>Origen: </strong><?php if($afro==1 and $indigena==1) echo "Afrodescendiente e indigena"; 
						else if($afro==1) echo "Afrodescendiente"; else if($indigena==1) echo "Indigena"; ?> </li>
					</ul>
