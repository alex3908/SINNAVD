    ...
    <div id="wrapper">
        ...
        <div id="main">
            <div class="inner">
                ...
                <form id="registro" enctype="multipart/form-data" name="registro" action="<?php $_SERVER['PHP_SELF'];?>"
                    method="POST">
                        ...
                        <li>
                            ...
                            <div class="select-wrapper">
                                <select id="respo" name="respo">
                                    ...
                                    <option value="<?php echo $row['id']; ?>"><?php echo $row['responsable']; ?>
                                    </option>
                                    <?php }?>
                                </select>
                            </div>
...
?>
								<section>
									<header class=" major">
                                                        <h4>PROCURADURÍA DE PROTECCIÓN DE NIÑAS, NIÑOS, ADOLESCENTES Y
                                                            LA FAMILIA</h4>
                                                        </header>
                                                        <p></p>
                                                        <ul class="contact">
                                                            <li class="fa-envelope-o"><a
                                                                    href="#">laura.ramirez@hidalgo.gob.mx</a></li>
