...
$registro = "INSERT INTO entrevistas_ts_adop (id_solicitud, fecha_entrevista, id_responsable, fecha_registro, id_perfil) values ($idSol, '$fechaEntre', $idDEPTO, '$fecha', $idPerfil)";
