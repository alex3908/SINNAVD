<?php	
	...
	$qResponsable="SELECT nombre from respon_nna where id=$idRespo";
	...
	if(!empty($_POST['eliminar']))
	{
		...
		$qDesactivar="UPDATE respon_nna set activo=0, respo_inactivo=$idDEPTO, fecha_inactivo='$fecha' where id=$idRespo";
			...
			<form id="familia" name="familia" action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" >	
				<div class="12u$">
					<ul class="actions">
						...
						<input class="button fit" type="button" name="cancelar" value="Cancelar" onclick="location='reg_per_respo.php?id=<?= $idReporte ?>'">
					</ul>
				</div>
			</form>				
		</div>
