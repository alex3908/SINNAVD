...
ob_start();
	...
	$buscaf="SELECT c.id, c.nombre, c.titular, c.tipo, c.calle, c.cp, e.estado, m.municipio, l.localidad, c.completo from centros c, estados e, municipios m, localidades l WHERE c.tipo!='PUBLICO' and c.id_estado=e.id and c.id_mun=m.id and c.id_loc=l.id";
	...
	<body>
		...
		<!-- Wrapper -->
			...
			<div class="row 10% uniform">
					...
					<?php if ($rows2>0) { ?>
						<input type="button" class="button special fit small" name="" value="registrar cas" onclick="location='reg_cas.php'">
					<?php }else {} ?>
