...
$agregar="INSERT INTO nna_caso (id_caso, id_nna, estado) VALUES ('$idCaso', '$idnin', 'NE')";
...
<html>
	...
	<body>
		...
		<!-- Wrapper -->
			...
			<section id="search" class="alt"><h1>Añadir NNA</h1>
				...
				<input type="button" class="button special fit small" name="expositos" value="EXPOSITOS" onclick="location='ag_nnae_caso.php?id=<?php echo $idCaso;?>'">
			</section>
