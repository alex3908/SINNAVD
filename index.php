			...
			<form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" >     
				<div class="box">
					<div class="row 10% uniform">
						<div class="4u"><img src="images/crece.jpg" width="50px" height="40px" /></div>
						<div class="4u"><img src="images/dif_horizontal.png" width="50px" height="40px" /></div>
						<div class="4u"><img src="images/armas.jpg" width="40px" height="40px"/></div>
					</div>
					<br>
