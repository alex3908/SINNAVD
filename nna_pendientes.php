...
tableObject.style.display = "block";
	...
	<body>
		...
		<?php if (isset($_POST['res'])) {
				...
				$query="SELECT nna.id, nna.folio, nna.nombre, nna.apellido_p, nna.apellido_m, nna.curp, nna.fecha_nac, departamentos.responsable from nna, departamentos where departamentos.id=nna.respo_reg and nna.curp='0' and nna.respo_reg='$idd'";
