											...
											<td><?php echo $row['id_usuario'];?></td>
												...
												<?php
												 ...
												 if ($mi==7 OR $mi==16) { ?>
												 			...
												 			<td><input type="submit" class="button special fit small" name="Terminar visita" value="Editar visita" onclick="location='update2.php?idVisita=<?php echo $row['id'];?>'"></td>
