...
FROM entrevistas_pscio_adop e
RIGHT JOIN entrevistas_rel_psico a on e.id_solicitud = a.id_solicitud
...
if ($band == true) {
    ...
    $sql = "UPDATE entrevistas_rel_psico SET entregado = '1', fecha_entrega = '$fechaEntrega' WHERE (id_solicitud = $idSolicitud)";
