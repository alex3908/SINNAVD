...
if (!empty($_POST)) {
    ...
    if ($eg) {
        ...
        $sqlNino = "INSERT INTO |o_cas (id_centro, id_nna, fecha_ing, motivo_ing,
                        ...
                        <div class="row uniform">
                            ...
                            <div class="3u 12u$(xsmall)">Motivo
                                <div class="select-wrapper">
                                    <select id="motivo" name="motivo" style="text-transform:uppercase;"
                                        onkeyup="this.value=this.value.toUpperCase();" required>
                                        <option value="DERIVACION A CENTRO ASISTENCIAL">DERIVACION A CENTRO ASISTENCIAL
                                        </option>
                            ...
                            <div class="12u">
                                <textarea name="seguimiento"
                                    placeholder="SEGUIMIENTO AL PROCESO DE REINCORPORACIÓN FAMILIAR O SOCIAL"
                                    style="text-transform:uppercase;" onkeyup="this.value=this.value.toUpperCase();"
                                    required></textarea>
                            </div>
