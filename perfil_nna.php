...
if (isset($_POST['padresCovid'])) {
    ...
    if ($estado == 1) {
        ...
        echo "<script>if(confirm('¿Desea realmente agregar orfandad de AMBOS PADRES?')){
        document.location='padres_fallecidos_covid.php?idNNA=$idNNA&estado=$estado';}
        </script>";
    }
...
<body>
                ...
                <div class="row uniform">
                    <div class="6u 12u$(xsmall)">
                        <div class="box">
                            <ul class="alt">
                                <li>
                                    <h4>Folio: </h4><?php echo $row['folio']; ?>
                                </li>
                                <li>
                                    <h4>Número identificador: </h4><?php echo $idNNA; ?>
                                </li>
                                <li>
                                    <h4>Sexo: </h4><?php echo $row['sexo']; ?>
                                </li>
                                <li>
                                    <h4>Fecha de nacimiento: </h4><?php if ($row['fecha_nac'] == '01/01/1900') {
    echo "Sin registro";
} else if (empty($row['fecha_nac'])) {
    echo "Sin dato valido";
} else {
    echo $row['fecha_nac'];
}
    ?>
                                ...
                                <li>
                                    <h4>Lugar de nacimiento: </h4><?php echo $row['lugar_nac']; ?>
                                </li>
                                <li>
                                    <h4>Lugar de registro: </h4><?php echo $row['lugar_reg']; ?>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="6u 12u$(xsmall)">
                        <div class="box">
                            <ul class="alt">
                                <li>
                                    <h4>Responsable actual del NNA: </h4><?php echo $row['responna']; ?>
                                </li>
                                <li>
                                    <h4>Parentesco: </h4><?php echo $row['parentesco']; ?>
                                </li>
                                <li>
                                    <h4>Dirección: </h4><?php echo $row['direccion']; ?>
                                </li>
                                <li>
                                    <h4>Telefono: </h4><?php echo $row['telefono']; ?>
                                </li>
                                <li>
                                    <h4>Observaciones: </h4><?php echo $row['observaciones']; ?>
                                </li>
                                <li> <button onclick="location='editarRespoNna.php?id=<?=$idNNA?>'">Editar</button></li>
                                <li>
                                    <form id="padres" name="padres" action="<?php $_SERVER['PHP_SELF'];?>"
                                        method="POST">
                                        <h4>Fallecidos por COVID-19: </h4>
                                        <?php if ($row['padre_fallecido_covid'] == 1 and $row['madre_fallecida_covid'] == 0) {?>
                                        <input type="radio" id="padreC" name="padresCovid" value="1"
                                            onchange="this.form.submit()" checked>
                                        <label for="padreC">Padre</label>
                                        <input type="radio" id="madreC" name="padresCovid" value="2"
                                            onchange="this.form.submit()" disabled>
                                        <label for="madreC">Madre</label>
                                        <input type="radio" id="AmbosPC" name="padresCovid" value="3"
                ...
                <div class="row uniform">
                    <div class="12u">
                        <div class="box">
                            <div class="row uniform">
                                <div class="6u">
                                    <b>De acuerdo con sus costumbres y tradiciones, ¿se considera parte de una comunidad
                                        indígena?</b> <br>
                                    <?php if ($row['indigena'] == 0) {
        echo "NO";
    } else {
        echo "SI";
    }
    ?>
                                ...
                                <div class="6u">
                                    <b>De acuerdo con sus costumbres y tradiciones, ¿se considera afroamericano(a) o
                                        afrodescendiente?</b> <br>
                                    <?php if ($row['afrodescendiente'] == 0) {
        echo "NO";
    } else {
        echo "SI";
    }
    ?>
                            ...
                            <div class="row uniform">
                                <div class="6u">
                                    <b>¿Es persona que abandona el lugar en que nació y llega al Estado para
                                        establecerse en él de manera temporal o definitiva?</b> <br>
                                    <?php if ($row['llegoAlEstado'] == 0) {
        echo "NO";
    } else {
        echo "SI";
    }
    ?>
                                ...
                                <div class="3u"><b>Especifique el origen</b>
                                    <br>
                                    <?php if (empty($row['origen']) and $row['migrante'] == 1) {
        echo "SIN INFORMACIÓN";
    } elseif ($row['migrante'] == 0) {
        echo "NO APLICA";
    } else {
        echo $row['origen'];
    }
    ?>
                                ...
                                <div class="3u"><b>Lugar</b>
                                    <br>
                                    <?php if (empty($row['lugOrigen']) and $row['migrante'] == 1) {
        echo "SIN INFORMACIÓN";
    } elseif ($row['migrante'] == 0) {
        echo "NO APLICA";
    } else {
    ...
    ?>
                            ...
                            <div class="row uniform">
                                <div class="4u">
                                    ...
                                    <?php if ($row['violentado'] == 1) {
        echo "SI";
    } elseif (empty($row['tipoViolencia'])) {
        echo "SIN INFORMACIÓN";
    } elseif ($row['violentado'] == 0) {
        echo 'NO';
    }
    ?>
                                </div>
                                <div class="3u">
                                    <b>Tipo</b><br>
                                    <?php if ($row['violentado'] == 1 and empty($row['tipoViolencia'])) {
        echo 'SIN INFORMACIÓN';
    } else {
        echo $row['tipoViolencia'];
    }
    ?>
                                </div>
                                <div class="3u">
                ...
                <br>
                <?php }
while ($rwDir = $rDireccion->fetch_assoc()) {?>
                <div class="box">
                    <div class="row uniform">
                        <div class="12u$">
                    ...
                    <div class="row uniform">
                        <div class="4u"></div>
                        <div class="4u">
                            <ul><button onclick="location='editarDireccionNna.php?id=<?=$idNNA?>'">Editar</button></ul>
                        </div>
                    </div>
                </div>
                <?php }?>
...
if (empty($idCas)) {
    ...
    $enomcaso = $mysqli->query($nomcaso);?>
                ...
                <div class="box">
                    <ul class="alt">
                        <li>
                            <h4>Folio del caso: <?php echo $row['folio_c']; ?></h4>
                        </li>
                        <li>
                            <h4>Nombre: <?php echo $row['nombre']; ?></h4>
                        </li>
                        <li>
                            <h4>Fecha de registro: <?php echo $row['fecha']; ?></h4>
                        </li>
                ...
                <?php if ($id_ddd == '16') {?>
                <input type="button" name="asignar_curso" class="button fit" value="eliminar NNA"
                    onclick="location='eliminar_nna.php<?php $_SESSION['idNNA'] = $idNNA;?>'">
